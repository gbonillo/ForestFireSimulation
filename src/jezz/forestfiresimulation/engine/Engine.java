 ...
 * Gère l'avancement du temps et la transformation de la forêt à chaque étape.
 * 
 * @author jezz
 */
public class Engine {
    ...
    /**
     * si != 0 permet d'utilisé toujours le même "seed"
     * pour obtenir le même tirage aléatoire 
     * et donc la même propagation du feu
     */
    ...
    /**
     * Détermine de façon "pseudo" aléatoire si une cellule voisine doit prendre feu
	 ...
	 */
	public boolean step(){
		if (forest.onFireCells.isEmpty()) return true; // si on a déjà fini, on fige le temps
